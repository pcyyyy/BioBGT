...
from module.InfoNCE import info_nce, InfoNCE
from cdlib.utils import convert_graph_formatsNiftiSpheresMasker
...
class GraphTransformer(nn.Module):
    ...
    def forward(self, data, return_attn=False):
        x, edge_index, edge_attr, abs_pe = data[0], data[1], None, None
        ...
        update_x = community_InfoNCE(output, data.adj, data.state)

        if abs_pe != None:
            abs_pe = self.embedding_abs_pe(data.abs_pe)
