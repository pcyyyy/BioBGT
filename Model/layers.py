...
class Attention(gnn.MessagePassing):
    ...
    def message(self, v_j, qk_j, qk_i, edge_attr, index, ptr, size_i, return_attn):
        ...
        # qk_i = qk_i.to(torch.float64)
        # qk_j = qk_j.to(torch.float64)
...
class TransformerEncoderLayer(nn.TransformerEncoderLayer):
    ...
    def forward(self, x, edge_index, complete_edge_index, edge_attr=None, degree=None, ptr=None,
            return_attn=False, update_x=None):
